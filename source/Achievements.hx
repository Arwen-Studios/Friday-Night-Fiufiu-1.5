...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Hiperativo",					"Complete uma música sem a animação Idle.",			'hype',					false],
		["Apenas nos dois",			    "Complete uma música apertando em apenas 2 setas.",	'two_keys',				false],
		["Torradeira Gamer",			"Já tentou rodar o God Of War na torradeira?",		'toastie',				false],
	];
